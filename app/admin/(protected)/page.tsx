    ...
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <Link href="/admin/requests" className="text-sm text-emerald-700 hover:underline mt-4 inline-block">
            View all requests →
          </Link>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <div className="space-y-2">
            ...
            {requestsByCategory.length === 0 && (
              <p className="text-sm text-slate-400">No requests filed yet.</p>
            )}
          </div>
        </div>
      </div>
